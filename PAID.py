...
\033[37;1m[\033[41;1mBLESSINGTHEHACKER\033[00;1m\033[37;1m ]\n

 \033[32;1mCreator \033[37;1m: \033[33;1mBLESSING
 
 \033[32;1mVersion \033[37;1m: \033[33;1m100                                   
"""
CorrectUsername = "BLESSING"
CorrectPassword = "FBPLUG"
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/BOSSHACKER1/PAID/.git")
			os.system("rm -rf PAID")
			os.system("cp -f PAID/PAID.py \\.")
			os.system("rm -rf PAID")
...
def crack_select1():
	...
	print("\033[92;1m  BLESSING CLONING ACTIVATED \x1b[0m")
	print("")
	linex()
	print("")
	def main(arg):
